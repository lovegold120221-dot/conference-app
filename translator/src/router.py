...
from dictionary_session import DictionarySession
...
class TranslationRouter:
    ...
    def __init__(self, room: rtc.Room, gemini_api_key: str) -> None:
        ...
        # May hold GeminiSession or DictionarySession instances.
        self._sessions: dict[SessionKey, GeminiSession | DictionarySession] = {}
    ...
    async def _reconcile(self) -> None:
        async with self._reconcile_lock:
            ...
            for key in desired - existing:
                ...
                # Route dictionary-based languages to DictionarySession.
                if target_lang in DICTIONARY_LANGS:
